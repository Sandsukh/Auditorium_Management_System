...
include('../../config.php');
$th=mysqli_query($con,"select * from tbl_e_organizer where id='".$_SESSION['EO']."'");
$eo=mysqli_fetch_array($th);
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg"><b>Event</b> Assistant</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo $eo['name'];?></span>
            </a>
      ...
      <ul class="sidebar-menu">
        <li class="treeview">
          ...
          <a href="add_event.php">
            <i class="fa fa-plus"></i> <span>Add Event</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview">
          <a href="view_event.php">
            <i class="fa fa-list-alt"></i> <span>View Events</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
