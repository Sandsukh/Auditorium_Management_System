  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add Event Organizer</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-body">
            <form action="process_add_organizer.php" method="post" id="form1">
              <div class="form-group">
                <label class="control-label">Organizer Name</label>
                <input type="text" name="name" class="form-control"/>
                <?php $frm->validate("name",array("required","label"=>"Organizer Name")); // Validating form using form builder written in form.php ?>
              </div>
              <div class="form-group">
                <label class="control-label">Organizer Address</label>
                <input type="text" name="address" class="form-control"/>
                <?php $frm->validate("address",array("required","label"=>"Organizer Address")); // Validating form using form builder written in form.php ?>
              </div>
              <div class="form-group">
              ...
              <?php //creates random passwords
                start:
                $username="EVE".rand(123456,999999);
              ...
              <div class="form-group">
                <button class="btn btn-success">Add Event Organizer</button>
              </div>
